...
echo Config Server will be available at: http://localhost:8888
echo.
...
echo API Gateway will be available at: http://localhost:8084
echo.
...
echo - http://localhost:8888/user-service/default
echo - http://localhost:8888/blog-service/default
echo - http://localhost:8888/engagement-service/default
echo ========================================
